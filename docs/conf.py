...
copyright = ' {0:%Y} <a href="http://nerdwallet.com">{1}</a>'.format(
    datetime.datetime.utcnow(), author
)
...
latex_documents = [
    (master_doc, "DynamORM.tex", "DynamORM Documentation", "NerdWallet", "manual")
]
...
man_pages = [(master_doc, "dynamorm", "DynamORM Documentation", [author], 1)]
